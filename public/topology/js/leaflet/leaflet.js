/*
 Leaflet 1.0.2+2996298, a JS library for interactive maps. http://leafletjs.com
...
function(t, e, i) {
        ...
        _off: function(t, e, n) {
            ...
            if (this._events && (s = this._events[t])) {
                ...
                if (n === this && (n = i), s) for (r = 0, a = s.length; r < a; r++) {
                    var h = s[r];
                    if (h.ctx === n && h.fn === e) return h.fn = o.Util.falseFn,
    ...
    o.DomUtil = {
        ...
        addClass: function(t, e) {
            if (t.classList !== i) for (var n = o.Util.splitWords(e), s = 0, r = n.length; s < r; s++) t.classList.add(n[s]);
    ...
    o.GridLayer = o.Layer.extend({
        ...
        _updateLevels: function() {
            ...
            s.el = o.DomUtil.create("div", "leaflet-tile-container leaflet-zoom-animated", this._container), s.el.style.zIndex = e, s.origin = r.project(r.unproject(r.getPixelOrigin()), t).round(), s.zoom = t, this._setZoomTransform(s, r.getCenter(), r.getZoom()), o.Util.falseFn(s.el.offsetWidth)),
            this._level = s,
            s
        },
        ...
        _setView: function(t, e, n, o) {
            var s = Math.round(e); (this.options.maxZoom !== i && s > this.options.maxZoom || this.options.minZoom !== i && s < this.options.minZoom) && (s = i);
    ...
    o.Layer.include({
        ...
        _openPopup: function(t) {
            ...
            if (this._popup && this._map) return o.DomEvent.stop(t),
    ...
    o.LineUtil = {
        ...
        _simplifyDPStep: function(t, e, i, n, o) {
            var s, r, a, h = 0;
            for (r = n + 1; r <= o - 1; r++) a = this._sqClosestPointOnSegment(t[r], t[n], t[o], !0),
            a > h && (s = r, h = a);
    ...
    o.Polyline = o.Path.extend({
        ...
        getCenter: function() {
            ...
            for (t = 0, n = 0; t < h - 1; t++) if (o = a[t], s = a[t + 1], i = o.distanceTo(s), n += i, n > e) return r = (n - e) / i,
        ...
        _clipPoints: function() {
            ...
            if (this._parts = [], this._pxBounds && this._pxBounds.intersects(t)) {
                ...
                for (e = 0, n = 0, s = this._rings.length; e < s; e++) for (h = this._rings[e], i = 0, r = h.length; i < r - 1; i++) a = o.LineUtil.clipSegment(h[i], h[i + 1], t, i, !0),
                a && (l[n] = l[n] || [], l[n].push(a[0]), a[1] === h[i + 1] && i !== r - 2 || (l[n].push(a[1]), n++))
            }
        },
    ...
    o.Control.Layers = o.Control.extend({
        ...
        _onInputClick: function() {
            ...
            for (var r = n.length - 1; r >= 0; r--) t = n[r],
